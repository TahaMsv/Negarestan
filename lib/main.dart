...
import 'package:negarestan/screens/create_post/create_post__state.dart';
...
void main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (_) => getIt<PostDetailsState>()),
      ChangeNotifierProvider(create: (_) => getIt<CreatePostState>()),
    ],
    child: MyApp(),
  ));
